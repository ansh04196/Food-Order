  ...
  return (
    <div className="m-auto w-4/5 my-5 py-2">
      ...
      <Section
        ...
        description={
          "Instamart is a grocery pickup and delivery service that allows customers to search for products, compare prices, and place orders online. The company aims to deliver groceries in 15 to 30 minutes through a network of seller-owned dark stores."
        }
